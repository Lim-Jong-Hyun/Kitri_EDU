 ...
 */
@WebServlet("/Board2FreeBoardEditController")
public class Board2FreeBoardEditController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Board2FreeBoardEditController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Board2Service service = new Board2ServiceImpl(
				new Board2DaoImpl());
		Board2 b = new Board2(Integer.parseInt(request.getParameter("num")), 1, null, request.getParameter("title"), 
