 ...
 */
@WebServlet("/Board1DriverRequestAddController")
public class Board1DriverRequestAddController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Board1DriverRequestAddController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (b.getMaxSeat() > 0 && b.getSeat() == 0 && b.getPassenger1() == null) {
			b.setPassenger1(m.getId());
			b.setSeat(2);
		} else if (b.getMaxSeat() > 1 && b.getSeat() == 1 && b.getPassenger2() == null) {
			b.setPassenger2(m.getId());
			b.setSeat(2);
		} else if (b.getMaxSeat() > 2 && b.getSeat() == 2 && b.getPassenger3() == null) {
