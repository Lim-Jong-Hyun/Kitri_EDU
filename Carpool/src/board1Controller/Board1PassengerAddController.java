 ...
 */
@WebServlet("/Board1PassengerAddController")
public class Board1PassengerAddController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Board1PassengerAddController() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Board1 b = new Board1(0, 1, cate, null, startTime, startPosi, endPosi, s_x, s_y, e_x, e_y, price, content, title, 0, 1, m.getId(), null, m.getId(), null, null, profile);
